...
while True:
    ...
    match user_action:
        case "add":
            file = open("D:\FFD WORK\FFD\Study_Resource_2026/4_Apr_26\Part-2\Day_7\File/todos.txt", "r")
            ...
            file = open("D:\FFD WORK\FFD\Study_Resource_2026/4_Apr_26\Part-2\Day_7\File/todos.txt", "w")
